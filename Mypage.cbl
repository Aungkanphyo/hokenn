       ...
       01 InputIMEI PIC X(15).

       

       PROCEDURE DIVISION.
       MAIN-PROCEDURE.
           display "Enter Your IMEI Number"
           accept InputIMEI
           ...
           IF WS-FOUND = "N"
               ...
               DISPLAY FUNCTION TRIM(InputIMEI) " not found!"
               DISPLAY "---------------------------------------------"
           ELSE
               DISPLAY "---------------------------------------------"
           END-IF
       ...
       PARSE-AND-CHECK.
           ...
           IF W-IMEI = InputIMEI
               MOVE "Y" TO WS-FOUND
               MOVE W-EST-PREMIUM   TO Formatted
           
             DISPLAY "============ APPLICATION RECEIPT ============"
             DISPLAY " IMEI NO         :      " W-IMEI
             DISPLAY " CUSTOMER        :      " W-NAME
             DISPLAY " Phone No        :      " W-PHONE
             Display " Date Of Birth   :      " W-DOB
             Display " Email           :      " W-EMAIL
             Display " Address         :      " W-ADDRESS
             Display " Postal code     :      " W-POSTAL-CODE
             Display " Date            :      " W-DATE
             Display " Time            :      " W-TIME
             Display " Status          :      " W-STATUS
             Display " Device Type     :      " W-DEVICE-TYPE
             Display " Device Model    :      " W-DEVICE-MODEL
             Display " Purchase Price  :      " W-PURCHASE-PRICE    
             Display " Purchase Date   :      " W-PURCHASE-DATE
             Display " Coverage Period :      " W-COVERAGE-PERIOD
             DISPLAY " PLAN NAME       :      " W-PLAN-NAME
             DISPLAY " EST PREMIUM     :      " 
                     function Trim(Formatted) "JPY"
             DISPLAY "============================================="
